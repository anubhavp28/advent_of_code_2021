...
print(image)
enhanced_image = iet.enhance(image)
print(enhanced_image)
double_enhanced_image = iet.enhance(enhanced_image)
print(double_enhanced_image)
print(double_enhanced_image.count('#'))
